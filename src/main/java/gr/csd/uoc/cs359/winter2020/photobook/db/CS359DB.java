...
public class CS359DB {
    ...
    private static final String UNAME = "csd3593"; // Share your repo to give you the credentials
    private static final String PASSWD = "M9$W4#Zx";  // Share your repo to give you the credentials
